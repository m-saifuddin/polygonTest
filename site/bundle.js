...
document.getElementById('me').onclick = function() {
    navigator.geolocation.getCurrentPosition(function(pos) {
        ...
        if (res.length) {
            ...
            L.marker([parseFloat(tempLat+""+0010),  parseFloat(tempLong+""+010)], {icon: educationIcon}).addTo(map).bindPopup("<b>Hello world!</b><br />I am a popup.").openPopup();
            L.marker([parseFloat(tempLat+""+0012), parseFloat(tempLong+""+012)], {icon: buildingIcon}).addTo(map).bindPopup("<b>Hello world!</b><br />I am a popup.").openPopup();
            L.marker([parseFloat(tempLat+""+0020), parseFloat(tempLong+""+020)], {icon: greenIcon}).addTo(map).bindPopup("<b>Hello world!</b><br />I am a popup.").openPopup();
