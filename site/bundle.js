...
document.getElementById('me').onclick = function() {
    navigator.geolocation.getCurrentPosition(function(pos) {
        ...
        if (res.length) {
            ...
            L.marker([parseFloat(tempLat+""+010),  parseFloat(tempLong+""+0010)], {icon: educationIcon}).addTo(map).bindPopup("<b>Hello world!</b><br />I am a popup.").openPopup();
            L.marker([parseFloat(tempLat+""+012), parseFloat(tempLong+""+0012)], {icon: buildingIcon}).addTo(map).bindPopup("<b>Hello world!</b><br />I am a popup.").openPopup();
            L.marker([parseFloat(tempLat+""+020), parseFloat(tempLong+""+0020)], {icon: greenIcon}).addTo(map).bindPopup("<b>Hello world!</b><br />I am a popup.").openPopup();
